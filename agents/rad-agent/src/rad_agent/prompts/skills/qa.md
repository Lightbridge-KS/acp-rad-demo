...
- `unsupported` — an IMPRESSION item with no basis in FINDINGS. Judge meaning, not wording: the impression is normally more concise than the findings, and a paraphrase is not unsupported.
